...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        'rounded-xl border border-white/10 bg-white/10 backdrop-blur-xl text-gray-100 shadow-[0_10px_30px_rgba(0,0,0,0.15)] transition-all duration-300 hover:bg-white/[0.15] hover:shadow-lg focus-within:shadow-lg',
        className,
      )}
      {...props}
    />
...
const InnerCard = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        'rounded-lg border border-white/10 bg-white/10 backdrop-blur-md p-2 sm:p-3 text-gray-100 transition-all duration-300 hover:bg-white/[0.15] hover:shadow-lg focus-within:shadow-lg',
        className,
      )}
      {...props}
    />
